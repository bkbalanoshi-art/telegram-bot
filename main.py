# ─── 🛠 پچ اجباری و استاندارد آیدی‌های جدید تلگرام (-1003...) ───
...
# ─── پردازش اصلی تمام پیام‌های خروجی ───
@app.on_message(filters.outgoing & ~filters.forwarded)
async def main_handler(client, message):
    ...
    # ۱. انتخاب عدد از لیست ۱۰ تایی (با ریپلای)
